...
\begin{figure}[htbp] % [htbp] specifies the preferred placement of the figure
  \centering % Centers the figure
  \includegraphics[width=0.8\textwidth]{path/to/your/image.png} % Adjust the width as needed
  \caption{Caption for the figure} % Adds a caption below the figure
  \label{fig:my_figure} % Adds a label for cross-referencing
\end{figure}
