...
\textcolor{darkgreen}{Question: How do the 2 different breed of dog which belongs to same class pull together in the latent space eventhough loss fn explicitly doesn't do that (situation specific to our dataset will be: some specific single dose image and
