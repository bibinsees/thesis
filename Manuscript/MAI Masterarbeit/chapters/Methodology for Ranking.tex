...
2. While inference we add explod images to see if they are overlapping with  control or single dose images when we take  softmax probability as metric for ranking. If there is no overlap that means it seperates control explod and single dose seperately we get 100 percentage accuracy.
\textcolor{red}{add image}
We train with 750 epochs, batch:8.
