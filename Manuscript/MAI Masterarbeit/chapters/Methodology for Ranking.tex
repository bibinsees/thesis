...
Similarly we use other dimensionality reduction techniques such as  t-SNE (t-Distributed Stochastic Neighbor Embedding)  and UMAP (Uniform Manifold Approximation and Projection) to reduce the higher dimension of data to single dimension to check whether these single dmension data tsne or umap values used for ranking  the images. 
\begin{table}[H]
  \centering
  \begin{tabular}{@{}lccccc@{}}
  \toprule
  \textbf{Metric}          & \textbf{Strong} & \textbf{Sweet} & \textbf{Resize} & \textbf{No Contrast Resize} & \textbf{No Contrast Sweet} \\ \midrule
  \textbf{Before projection head} & 73.33                & 51.87              & 49.59               & 34.80                        & 77.56                          \\
  \textbf{After projection head} & 80.49                & 21.95              & 76.75               & 76.75                          & 31.71                          \\ \bottomrule
  \end{tabular}
  \caption{PCA}
  \label{tab:distances}
\end{table}
...
\begin{table}[H]
  ...
  \toprule
  \textbf{Metric}          & \textbf{Strong} & \textbf{Sweet} & \textbf{Resize} & \textbf{No Contrast Resize} & \textbf{No Contrast Sweet} \\ \midrule
  \textbf{Before projection head} &  93.33               & 99.51              & 99.35               & 93.50                          & 99.67                          \\
  \textbf{After projection head} & 93.50               & 34.47              & 56.26               & 25.53                          & 93.50                       \\ \bottomrule
  \end{tabular}
  \caption{umap}
  \label{tab:distances}
\end{table}
...
\begin{table}[H]
  ...
  \toprule
  \textbf{Metric}          & \textbf{Strong} & \textbf{Sweet} & \textbf{Resize} & \textbf{No Contrast Resize} & \textbf{No Contrast Sweet} \\ \midrule
  \textbf{Before projection head} & 99.84                & 100              & 100               & 100                          & 99.19                          \\
  \textbf{After projection head} & 74.63                & 55.61              & 98.70               & 76.75                          & 31.71                          \\ \bottomrule
  \end{tabular}
  \caption{tsne}
  \label{tab:distances}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|l|}
  \hline
  \multicolumn{1}{|c|}{Pca} & tsne & umap \\ \hline
                         54.47   &  54.80    & 17.56     \\ \hline
  \end{tabular}
  \end{table}
