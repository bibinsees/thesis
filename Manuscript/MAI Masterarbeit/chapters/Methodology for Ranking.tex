...
Similarly we use other dimensionality reduction techniques such as  t-SNE (t-Distributed Stochastic Neighbor Embedding)  and UMAP (Uniform Manifold Approximation and Projection) to rank the images. 
\begin{table}[H]
  \centering
  \begin{tabular}{@{}lccccc@{}}
  \toprule
