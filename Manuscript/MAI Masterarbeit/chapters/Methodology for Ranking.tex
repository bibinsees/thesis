...
\begin{table}[H]
  ...
  \caption{Comparison of dimensionality reduction techniques (PCA, UMAP, t-SNE) on before and after the projection head SimCLR features for ranking strategy.}
...
\begin{table}[H]
  ...
  \begin{tabular}{lccc}
      ...
      \bottomrule
  \end{tabular}
  \caption{Comparison of dimensionality reduction techniques (PCA, UMAP, t-SNE) on original image vectors for ranking strategy.}
