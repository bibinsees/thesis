...
Initialy I used original dataset of control (472 images) and single dose images (103 images) as explained in the dataset table and we used explod ( 40m images) that we get from dalias classifier model.
I train with differnet parameters for  number of epochs and batch size. following parameers gave higher accuracy: 750 epochs, batch:8. every other parameter is same as explained in the classification chapter.
...
\begin{table}[H]
  ...
  Cond7 vs SD             & 25.04            & 49.75           & 76.91          & 85.85                         & 89.99                        \\
  Cond7 vs Ex             & 83.41            & 49.27               & 85.12           & 60.49                          &    71.54                 \\
...
As we seen in the above table, none of the  data augmentation types are not able to give clear seperation between 3 classes. but interestingly overlap between class happened only between explod and control softmax values not with single dose. No contrast sweet  Another interesting 
...
\begin{table}[H]
  ...
  Cond7 vs Ex             & 97.54               & 96.49              & 98.94               & 98                          &   97.54                        \\ \bottomrule
  \end{tabular}
  \caption{Table description goes here.}
  \label{tab:ranking softmax}
\end{table}
