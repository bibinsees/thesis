...
\begin{table}[H]
  ...
  \multirow{3}{*}{\textbf{Before Projection Head}} 
                               ...
                               & t-SNE                 & 99.84           & \textbf{100.00}         & \textbf{100.00}          & \textbf{100.00}                       & 99.19                      \\ \midrule
...
While comparing amoung before projection head: Above table shows that PCA reducing data dimension to 1 D doesn't seperate 3 classes well comapre to the tsne and umap. While Umap achieved closer to 100, Tsne performed better amoung all dimesnionality redcution technic  with the achievance of 100 percentage accuracy to seperate 3 classes in sweet, resize, No contrast data augmentation pipelines. 