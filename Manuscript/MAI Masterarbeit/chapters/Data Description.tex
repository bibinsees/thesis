...
The original images are approximately 2500×2500 pixels in size, in 16-bit grayscale,
 ...
 focal planes in brightfield microscopy. The number of channels can vary, as you can take
  ...
  But lately I found out that within the same image each channel/layer are not also out of focus according
  to the focal plane, but also they are in slightly different position due to microscopic handle error i guess.
  this can leads to error when we stack those as channels in the training of model. thats why we have to
