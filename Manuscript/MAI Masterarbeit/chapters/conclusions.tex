...
\begin{table}[H]
	...
	\begin{tabular}{@{}lc@{}}
	\toprule
	\textbf{Ranking Strategy}                                                                       & \textbf{Old Accuracy} \\ \midrule
	Softmax: cond7 vs sd                                                                            & 100                   \\ 
	Softmax: cond7 vs Ex                                                                            & 100                   \\ 
	\begin{tabular}[c]{@{}l@{}}K-means: After cosine strong\\ using single dose mean\end{tabular}   & 95.12                 \\ 
	PCA: strong cosine distance                                                                     & 100                   \\ 
	PCA: Euclidean strong                                                                           & 99.17                 \\ \bottomrule
	\end{tabular}%
	}
