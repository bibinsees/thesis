...
run 150 times for different random initilisation.
...
\textcolor{red}{Should I need to add precision recall? yes to confirm control exploded lokk like is the one who reduces the accuracy. maybe for full dataset where 
accuracy lw and included control looks like explod}
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}llcccc@{}}
        ...
        & Euclidean Distance & 81.48     & -   & -   & -   \\ \bottomrule
    \end{tabular}%
    }
\end{table}
