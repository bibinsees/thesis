...
Train loss vs Val loss . Train accurcay  vs val accuracy 
          ...
          \begin{figure}[H]
            \centering
            \includegraphics[scale=0.95]{figures/orig_classi.png} 
            \caption{orig}
            \label{fig:orig}
          \end{figure}
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}llcccc@{}}
        ...
        & Strong                & 93.33 & 100 & 100 & 100 \\
        & Sweet                 & 97.89 & 100 & 100 & 100 \\
        & Resize                & 93.17 & 97.50 & 97.87 & 100 \\
        & Resize No Contrast    & 90.57 & 90.00 & 90.54 & 100 \\
        & Sweet No Contrast     & 94.96 & 99.17 & 99.53 & 99.17 \\ \midrule
        \multirow{5}{*}{\textbf{After}} 
        & Strong                & 86.83 & 92.5 & 89.83 & 100 \\
        & Sweet                 & 76.75 & 68.33 & 77.07 & 72.50 \\
        & Resize                & 89.59 & 92.50 & 88.42 & 100 \\
        & Resize No Contrast    & 76.75 & 59.17 & 68.56 & 63.33 \\
        & Sweet No Contrast     & 76.75 & 81.67 & 75.41 & 86.67 \\ \bottomrule
    \end{tabular}%
    }
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}llcccc@{}}
        ...
        \textbf{Projection Head} & \textbf{Augmentation Type} & \textbf{Full Dataset (Unbalanced)} & \textbf{40 Subset (Balanced)} & \textbf{Curated Full Dataset} & \textbf{Curated 40 Subset} \\ \midrule
        \multirow{5}{*}{\textbf{Before}} 
        & Strong                & 93.5 & 100 & 100 & 100 \\
        & Sweet                 & 98.05 & 91.67 & 99.30 & 95.83 \\
        & Resize                & 89.43 & 79.17 & 89.36 & 87.50 \\
        & Resize No Contrast    & 92.52 & 90.00 & 90.54 & 100 \\
        & Sweet No Contrast     & 99.02 & 97.50 & 99.76 & 99.17 \\ \midrule
        \multirow{5}{*}{\textbf{After}} 
        & Strong                & 93.33 & 100 & 89.83 & 100 \\
        & Sweet                 & 76.75 & 68.33 & 79.43 & 74.17 \\
        & Resize                & 76.75 & 83.33 & 74.70 & 87.50 \\
        & Resize No Contrast    & 76.75 & 59.17 & 66.19 & 60.83 \\
        & Sweet No Contrast     & 76.75 & 81.67 & 77.30 & 81.67 \\ \bottomrule
    \end{tabular}%
    }
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}llcccc@{}}
        ...
        & Cosine Distance    & 76.75 & 65.83   & 82.25   & 65.83   \\ 
