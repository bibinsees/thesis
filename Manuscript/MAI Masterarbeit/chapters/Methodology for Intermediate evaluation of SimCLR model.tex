...
\begin{table}[h!]
    \centering
    \caption{Comparison of Classification Accuracy and Epochs for Different Data Augmentations}
    \label{tab:aug_results}
    \begin{tabularx}{\textwidth}{@{}l*{4}{c}@{}}
    \toprule
    \textbf{Augmentation Type} & \multicolumn{2}{c}{\textbf{After Projection Head}} & \multicolumn{2}{c}{\textbf{Before Projection Head}} \\ 
    \cmidrule(lr){2-3} \cmidrule(lr){4-5}
                               & \textbf{Train Accuracy (\%)} & \textbf{Train Epoch}  & \textbf{Test Accuracy (\%)} & \textbf{Test Epoch}  \\ \midrule
    Strong                     & 85.4                        & 15                    & 100                        & 20                   \\
    Sweet                      & 87.2                        & 14                    & 100                        & 18                   \\
    Resize                     & 82.6                        & 18                    & 100                        & 25                   \\
    Resize No Contrast         & 100                        & 24                    & 100                        & 2                   \\
    Sweet No Contrast          & 83.5                        & 16                    & 100                        & 22                   \\ \bottomrule
    \end{tabularx}
\end{table}
    ...
    \begin{table}[]
        ...
        \hline
        Augmentation Type                            &                            &          & Strong & Sweet & Resize & Resize No Contrast & Sweet No Contrast \\ \hline
        \multicolumn{1}{|l|}{After Projection Head}  & \multicolumn{1}{l|}{}      & Accuracy &  88     & 59.76     & 97.15      & 58.74                  & 56.30                \\ \cline{3-8} 
        \multicolumn{1}{|l|}{}                       & \multicolumn{1}{l|}{Train} & Epoch    &  249     & 248     & 236      & 239                  & 249                \\ \cline{2-8} 
        \multicolumn{1}{|l|}{}                       & \multicolumn{1}{l|}{Test}  & Accuracy &  86.18    & 62.60     & 96.75      & 53.66                & 51.22                \\ \cline{3-8} 
        \multicolumn{1}{|l|}{}                       & \multicolumn{1}{l|}{}      & Epoch    &  240     & 235     & 239      & 248                  & 237                 \\ \hline
        \multicolumn{1}{|l|}{}                       & \multicolumn{1}{l|}{Train} & Accuracy & 100    & 100   & 100  & 100                & 100               \\ \cline{3-8} 
        \multicolumn{1}{|l|}{Before Projection Head} & \multicolumn{1}{l|}{}      & Epoch    & 148     & 18     & 62    & 14                & 44                \\ \cline{2-8} 
        \multicolumn{1}{|l|}{}                       & \multicolumn{1}{l|}{Test}  & Accuracy & 100    & 100   & 100  & 100                & 100               \\ \cline{3-8} 
        \multicolumn{1}{|l|}{}                       & \multicolumn{1}{l|}{}      & Epoch    & 1      & 1     & 2   & 2                  & 2                \\ \hline
        \end{tabular}%
        }
    \end{table}
...
\begin{table}[h!]
    ...
    \textbf{Original Image}    & 95.12                      & 18                    & 94.31                        & 15                   \\ \hline
    \end{tabular}
\end{table}
...
\textcolor{red}{Should I need to add precision recall etc?} 
...
\begin{table}[h!]
    ...
    \hline
    Augmentation Type                            &                            &          & Strong & Sweet & Resize & Resize No Contrast & Sweet No Contrast \\ \hline
    \multicolumn{1}{|l|}{After Projection Head}  & \multicolumn{1}{l|}{}      & Accuracy &  -     & -     & -      & -                  & -                 \\ \cline{3-8} 
    \multicolumn{1}{|l|}{}                       & \multicolumn{1}{l|}{Train} & Epoch    &  -     & -     & -      & -                  & -                 \\ \cline{2-8} 
    \multicolumn{1}{|l|}{}                       & \multicolumn{1}{l|}{Test}  & Accuracy &  -     & -     & -      & -                  & -                 \\ \cline{3-8} 
    \multicolumn{1}{|l|}{}                       & \multicolumn{1}{l|}{}      & Epoch    &  -     & -     & -      & -                  & -                 \\ \hline
    \multicolumn{1}{|l|}{}                       & \multicolumn{1}{l|}{Train} & Accuracy &  -     & -     & -      & -                  & -                 \\ \cline{3-8} 
    \multicolumn{1}{|l|}{Before Projection Head} & \multicolumn{1}{l|}{}      & Epoch    &  -     & -     & -      & -                  & -                 \\ \cline{2-8} 
    \multicolumn{1}{|l|}{}                       & \multicolumn{1}{l|}{Test}  & Accuracy &  -     & -     & -      & -                  & -                 \\ \cline{3-8} 
    \multicolumn{1}{|l|}{}                       & \multicolumn{1}{l|}{}      & Epoch    &  -     & -     & -      & -                  & -                 \\ \hline
    \end{tabular}%
    }
