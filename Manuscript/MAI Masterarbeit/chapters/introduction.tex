...
\begin{enumerate}[itemsep=0.5em, parsep=0pt] % Adjust 'itemsep' for spacing between items
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\linewidth]{figures/well.png} % Adjust the width as needed
