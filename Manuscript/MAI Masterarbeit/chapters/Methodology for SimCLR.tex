...
\begin{enumerate}
  ...
  repeatable pattern to the above as shown in figure and due to the black cut problem explained in \ref{fig:rotation}.
  \item Randomly change the brightness, contrast, saturation  upto lower=1-0.8, upper=1+0.8 and hue upto 0.2 times.
\end{enumerate}

I call it as strong data augmentation. I found that those strong augmentations transformed to distribution out of 
the original distribution like we see in the figures below. specifically color jitterness including brightness, 
contrast, hue, saturation. 



eventhough we know that these kind of 
strong augmentations is sensitive to our dataset, I was speculate that strong augmentation may have better learned latent space representations.
