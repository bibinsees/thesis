...
\begin{acronym}[UMAP] % The argument "UMAP" is the longest acronym for proper alignment.
  \acro{PCA}{Principal Component Analysis}
  \acro{t-SNE}{t-distributed Stochastic Neighbor Embedding}
  \acro{UMAP}{Uniform Manifold Approximation and Projection}
  \acro{ML}{Machine Learning}
  \acro{control}{untreated images}
  \acro{control day 10}{control day 10}
  \acro{Explode}{Explode}
